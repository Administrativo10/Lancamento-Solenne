        ...
        <div className="flex flex-col items-end max-w-5xl md:max-w-6xl space-y-8 md:space-y-10 ml-auto text-right">
          ...
          <div className="space-y-4 text-right animate-fade-up opacity-0 relative" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            <h1 className="text-white leading-[1.1] tracking-tight">
              <span className="block text-3xl md:text-5xl lg:text-6xl font-light text-white/90 mb-3 tracking-wide text-balance">
                Receba <br /> <strong className="font-bold text-white">EM PRIMEIRA MÃO</strong>, <br /> detalhes do mais novo empreendimento
              </span>
              <span className="block text-3xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-100 via-amber-300 to-amber-100 drop-shadow-sm whitespace-nowrap">
